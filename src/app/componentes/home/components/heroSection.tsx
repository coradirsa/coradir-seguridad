    ...
    return (
        <section className="flex flex-col justify-start items-center bg-white">
            < div className="w-full h-[50vh] md:h-[80vh] xl:h-[100vh] flex flex-col items-end  justify-end overflow-hidden relative" >
                ...
                <p className=" p-3 terxt-lg bg-red text-white text-left rounded-tr-2xl  rounded-bl-2xl w-[40%] md:block hidden text-xl xl:text-4xl xl:px-20 xl:w-[60%] xl:mr-[25%] xl:p-12 z-1">
                  Cuidamos tu tranquilidad, la de quienes te rodean y nos adaptamos a tus necesidades
                </p>
            </div> 
           <p className=" p-3 terxt-lg bg-red text-white text-center rounded-tr-2xl container rounded-bl-2xl w-[80%] md:w-[40%] md:hidden z-1">
           Cuidamos tu tranquilidad, la de quienes te rodean y nos adaptamos a tus necesidades
           </p>
        </section>
    )
